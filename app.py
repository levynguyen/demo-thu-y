         ...
         try:
            ...
            if image:
               ...
               # source = "data/images/sample4.jpg"
                        ...
                        if len(det):
                            ...
                            for *xyxy, conf, cls in reversed(det):
                                if save_img:  # Add bbox to image
                                    ...
                                    extra += str(names[int(cls)]) + " với độ tin cậy <b>{:.2f}% ".format(conf)
                ...
                return render_template("index.html", user_image = image.filename, msg="Tải file lên thành công",extra = Markup(extra))
